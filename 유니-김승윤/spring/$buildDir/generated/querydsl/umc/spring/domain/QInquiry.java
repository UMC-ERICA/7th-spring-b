...
public class QInquiry extends EntityPathBase<Inquiry> {
    ...
    public final ListPath<umc.spring.domain.images.InquiryImageSave, umc.spring.domain.images.QInquiryImageSave> images = this.<umc.spring.domain.images.InquiryImageSave, umc.spring.domain.images.QInquiryImageSave>createList("images", umc.spring.domain.images.InquiryImageSave.class, umc.spring.domain.images.QInquiryImageSave.class, PathInits.DIRECT2);
