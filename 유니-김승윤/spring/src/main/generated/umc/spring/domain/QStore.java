...
public class QStore extends EntityPathBase<Store> {
    ...
    public final ListPath<StoreImageSave, QStoreImageSave> images = this.<StoreImageSave, QStoreImageSave>createList("images", StoreImageSave.class, QStoreImageSave.class, PathInits.DIRECT2);
